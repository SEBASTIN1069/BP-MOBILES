  ...
  laptopTableBody.innerHTML = snap.docs.map((doc) => {
    ...
    return `
      <tr>
        ...
        <td class="admin-row-actions">
          <button type="button" class="btn btn-ghost btn-sm" data-edit-laptop="${doc.id}">Edit</button>
          <button type="button" class="btn btn-danger btn-sm" data-delete-laptop="${doc.id}">Delete</button>
        </td>
      </tr>
    `;
  }).join("");
